...
## Voice-feature variant (run after hero validates)

> Every Vistalia tour is narrated — and Pro agents can clone their own voice,
> so every listing you post sounds like *you* showed it.
(Feature messaging only. No founder voice in the creative itself.)

## Targeting notes (launch)

- US · 25-65 · interests: real estate agent, Realtor.com, Zillow Premier
  Agent, MLS, real estate marketing · narrow: job title real estate agent /
